...
used data provided from data provided from \ac{HGOIA}, a specialized
...
\ac{HGOIA} in Quito, Ecuador. Our research goal is to train a
...
Hospital \ac{HGOIA}. However, the digital records are most
...
variables of each dataset towards prediction. For the \ac{HGOIA} dataset, the most important features are: patient's age,
...
AWS SageMaker Canvas was pivotal in
...
\institutionalreview{The study was conducted in accordance with the
  ...
  anonymized medical records provided by the Isidro Ayora Gynecology
  and Obstetrics Hospital \ac{HGOIA}.}
