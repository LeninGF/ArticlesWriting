...
\bottomrule
\end{tabularx}
\added[id=R2]{\noindent\footnotesize{\textsuperscript{a}Mann-Whitney $U$ test, two-sided; compares each variable between the preeclampsia and normal groups (computed from \texttt{05-statistical-tests-p-values.ipynb}).}}
...
\bottomrule
\end{tabularx}
\added[id=R2]{\noindent\footnotesize{\textsuperscript{b}Pearson chi-squared test of independence between variable bin and preeclampsia status (computed from \texttt{05-statistical-tests-p-values.ipynb}).}}
