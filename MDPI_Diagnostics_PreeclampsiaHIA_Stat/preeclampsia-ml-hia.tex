...
In Ecuador, the Clinical Practice Guideline from the \ac{MSP} (Ministry of Public Health) identifies
...
both on the real and synthetic data to diagnose
...
a descriptive analysis of real hospital data from \ac{HGIO}, (ii) a cloud-managed benchmarking workflow, and (iii) a
...
interpretable \ac{PE} modeling in a real public-hospital
environment.
...
at the hospital according to \ac{ICD-10}. All records were anonymized
in compliance with ethical requirements approved by the
\ac{PUCE} Research Ethics
Committee for Human Subjects (CEISH-PUCE, approval code: EO-086-2024,
version~4)..
...
\end{tikzpicture}%
\end{adjustwidth}
\caption{Preprocessing workflow used to construct the real-data
...
To complement the real-world demographic dataset and compensate for
...
evidence of equivalent performance in real clinical deployment.
...
\acknowledgments{The authors gratefully acknowledge the financial
  support provided by the \textit{Escuela Politécnica Nacional}
  ...
  Timbi, Zonal Health Coordinators of Zone 9 of the Ministerio de Salud Pública (MSP), for their support and collaboration in facilitating
  ...
  support. In particular, we thank Hospital Isidro Ayora, especially
...
conda-forge-based distribution of Anaconda~\cite{anaconda2020}, with additional
