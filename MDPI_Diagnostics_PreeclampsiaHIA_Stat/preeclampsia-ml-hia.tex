...
worldwide. The ac{WHO} reports that preeclampsia
...
\ac{HGIO}\footnote{\textit{Hospital Gineco Obstétrico Isidro Ayora}, a
...
preeclampsia. Different to the full\ac{PIERS} standard, which is a
prognostic model, our goal is to determine the most effective set of
models to diagnose preeclampsia according to the Ecuadorian realm.
...
server at Escuela Politecnica Nacional.
