...
\textit{Pontificia Universidad Católica del Ecuador} Research Ethics
...
prediction toward preeclampsia. \texttt{Proteinuria\_24h\_mg},
...
preeclampsia risk markers and is fully consistent with the
...
\dataavailability{The anonymized patient dataset from Hospital
  ...
  \url{https://github.com/LeninGF/ArticlesWriting} and will be made
...
\acknowledgments{The authors gratefully acknowledge the financial
  ...
  Timbi, Zonal Health Coordinators of Zone 9 of the Ministry of Public
  Health (MSP), for their support and collaboration in facilitating
  access to clinical data. We also thank Dr. Raysa A. Fuertes Arévalo
  for her valuable guidance throughout the development of this
  study. Furthermore, we acknowledge the hospitals within Zone 9 for
