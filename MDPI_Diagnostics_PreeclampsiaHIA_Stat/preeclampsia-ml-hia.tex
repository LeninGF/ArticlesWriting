...
worldwide, being associated with more than \numprint{70000}
...
proposed in~\cite{fullpiers_2011}.
...
The record-level prevalence of \ac{PE} in the final
...
\toprule
Variable & Preeclampsia & Sample Size & Mean & Median & Std.\ Dev. & $p$-value\textsuperscript{a} \\
\midrule
...
\toprule
Variable & Bin (range) & Total pregnancies & Normal pregnancies & Preeclampsia pregnancies & Preeclampsia prevalence (\%) & $p$-value\textsuperscript{b} \\
\midrule
...
For \ac{HPO}, C-AutoML adopts a \textit{random search}
...
Figure~\ref{fig:c-automl-flowchart} provides a flowchart
...
\end{tikzpicture}
\end{adjustwidth}
\caption{Flowchart of the \ac{C-AutoML} training
...
For the synthetic dataset, all six evaluated model
  ...
  outcomes of \ac{PE}, which differs from our main purpose.
%% [OLD R1]: For
...
Notwithstanding these limitations, the study benefits from
