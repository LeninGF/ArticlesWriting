...
\added[id=R2]{Several recent studies have further narrowed the
comparison to tree-based ensembles operating on demographic and
routinely collected clinical variables, reporting AUC values in the
0.80--0.96 range depending on predictor
availability~\cite{liu_pregnancy_trajectories_2022,zeng_preeclampsia_ml_china_2024,advancing_ml_preeclampsia_2025,bias_free_severe_pe_2024}.
A 2026 systematic review confirms that performance heterogeneity
across studies is largely driven by differences in predictor sets
and population characteristics, supporting comparisons restricted
to works with broadly similar frameworks and variable
types~\cite{jmijr_ml_pe_review_2026}.
Table~\ref{tab:ml_pe_comparison} in the Discussion provides a
structured comparison of our results against these studies.}
...
\begin{figure}[H]
  ...
  \begin{adjustwidth}{-\extralength}{0cm}
    \centering
    \includegraphics[width=\textwidth, height=.4\textheight]{./figures/Aws-Wrangler-Operations.png}    %  figures/AWS-WRANGLER-OPS-600-DPI.png
  \end{adjustwidth}
...
\added[id=R2]{The record-level \ac{PE} prevalence in the final \ac{ML} dataset
...
\toprule
Variable & Preeclampsia & Sample Size & Mean & Median & Std.\ Dev. & \added[id=R2]{$p$-value\textsuperscript{a}} \\
\midrule
AGE (YEARS) & No & 3571 & 18.71 & 18.00 & 4.13 & \added[id=R2]{\multirow{2}{*}{$<$0.001}} \\
          & Yes & 674  & 29.72 & 30.00 & 7.17 &  \\
\midrule
BMI       & No & 3571 & 25.71 & 25.19 & 4.39 & \added[id=R2]{\multirow{2}{*}{$<$0.001}} \\
          & Yes & 674  & 33.00 & 32.63 & 6.02 &  \\
\midrule
GESTATIONAL  & No & 3571 & 27.55 & 27.70 & 7.76 & \added[id=R2]{\multirow{2}{*}{$<$0.001}} \\
WEEKS                   & Yes & 674  & 33.80 & 35.40 & 4.42 &  \\
\midrule
WEIGHT    & No & 3571 & 61.20 & 59.50 & 11.67 & \added[id=R2]{\multirow{2}{*}{$<$0.001}} \\
...
\begin{tabularx}{\textwidth}{llXXp{2.cm}Xr}
% R2: p-value column added (Pearson chi-squared; 05-statistical-tests-p-values.ipynb)
\toprule
Variable & Bin (range) & Total pregnancies & Normal pregnancies & Preeclampsia pregnancies & Preeclampsia prevalence (\%) & \added[id=R2]{$p$-value\textsuperscript{b}} \\
\midrule
AGE         & (12.999, 17.0] & 1745 & 1704 & 41 & 2.35\% & \added[id=R2]{\multirow{4}{*}{$<$0.001}} \\
(YEARS)     & (17.0, 18.0]   & 690  & 670  & 20  & 2.90\% &  \\
            & (18.0, 22.0]   & 797  & 735  & 62  & 7.78\% &  \\
            & (22.0, 48.0]   & 1013 & 462  & 551 & 54.39\% &  \\
\midrule
AGE GROUP   & 10–14 years    & 73   & 66   & 7   & 9.59\% & \added[id=R2]{\multirow{4}{*}{$<$0.001}} \\
            & 15–19 years    & 2877 & 2813 & 64  & 2.22\% &  \\
            & 20–35 years    & 1100 & 663  & 437 & 39.73\% &  \\
            & 36–49 years    & 195  & 29   & 166 & 85.13\% &  \\
\midrule
BMI         & (15.329, 23.18] & 1063 & 1041 & 22  & 2.07\% & \added[id=R2]{\multirow{4}{*}{$<$0.001}} \\
            & (23.18, 25.93]  & 1064 & 1014 & 50  & 4.70\% &  \\
            & (25.93, 29.42]  & 1058 & 935  & 123 & 11.63\% &  \\
            & (29.42, 73.46]  & 1060 & 581  & 479 & 45.19\% &  \\
\midrule
GESTATIONAL & (3.399, 26.0]   & 1066 & 1055 & 11  & 1.03\% & \added[id=R2]{\multirow{4}{*}{$<$0.001}} \\
WEEKS       & (26.0, 27.696]  & 1229 & 1062 & 167 & 13.59\% &  \\
            & (27.696, 35.2]  & 904  & 760  & 144 & 15.93\% &  \\
            & (35.2, 41.5]    & 1046 & 694  & 352 & 33.65\% &  \\
\midrule
WEIGHT      & (19.799, 54.0]  & 1086 & 1065 & 21  & 1.93\% & \added[id=R2]{\multirow{4}{*}{$<$0.001}} \\
...
\added[id=R2]{\textbf{Comparison with similar frameworks.}
Table~\ref{tab:ml_pe_comparison} situates our results among studies
that employ comparable model families and predictor types.
Despite using only four demographic variables, our best models achieve
discrimination metrics (AUC~0.944--0.956, F1~0.802--0.805) that fall
within the range reported for tree-based ensembles operating on richer
predictor sets~\cite{LI2021102,liu_pregnancy_trajectories_2022,zeng_preeclampsia_ml_china_2024,advancing_ml_preeclampsia_2025}.
...
reviews~\cite{Darsareh2024,Rahman2023,jmijr_ml_pe_review_2026};
the comparison in Table~\ref{tab:ml_pe_comparison} is therefore
intended to contextualise rather than rank performance.}

\begin{table}[H]
  \small
  \centering
  \caption{\added[id=R2]{Comparison of selected machine learning
    studies for preeclampsia prediction using tabular demographic
    and clinical data.}\label{tab:ml_pe_comparison}}
  \begin{adjustwidth}{-\extralength}{0cm}
  \begin{tabularx}{\fulllength}{p{2.5cm}p{3.5cm}p{3.8cm}p{3.2cm}}
    \toprule
    ...
    3,759 pregnancies, EHR from a tertiary hospital in China &
    ...
    \textbf{4,165 pregnancies, public hospital in Ecuador} &
...
\added[id=R2]{Regarding patient selection, the positive class was constructed
...
severity grade or gestational age at onset; subgroup analysis constitutes a
direction for future research.}

\added[id=R2]{Notwithstanding these limitations, the study benefits from
