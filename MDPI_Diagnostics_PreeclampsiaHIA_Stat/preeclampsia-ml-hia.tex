...
\textbf{Cloud-managed training (Amazon SageMaker Canvas).}
Amazon SageMaker Canvas is a managed visual machine-learning service that
...
family, a \ac{HPO} configuration is stochastically sampled from
