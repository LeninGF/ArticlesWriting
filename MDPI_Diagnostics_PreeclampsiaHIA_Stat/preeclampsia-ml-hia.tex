...
($\ac{AC}=0.920$, $\mathtt{Precision}=0.447$, $\mathtt{Recall}=0.789$,
...
\subsection{Logistic Regresion Model on Clinical Synthetic Generated Data}
...
\subsection{Logistic Regresion on Synthetic Data}
...
for best hyperparameter alignment. The besto model found corresponded
