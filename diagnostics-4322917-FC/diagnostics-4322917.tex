...
juan.benavides@epn.edu.ec~(J.B.)\\ %<<AUTHOR: added maria.perez to the
                                %list of emails from EPN>>
$^{2}$ \quad Smartwork S.A.,  {Quito 170503, Ecuador;} %MDPI: Newly
                                %added  information. Please
                                %confirm. <<AUTHOR: Confirmed!>>
 andres.bastidas@smartwork.com.ec~(A.B.-F.)\\ % <<AUTHOR: added
                                % acronym for author Andres Bastidas>>
...
% a Post Office Box number can be added instead. <<AUTHOR:Added.>>
 Ecuador; raysafuertesa@gmail.com~(R.A.F.-A.)} %<<AUTHOR:Added acronym
for author Raysa Fuertes>>
...
\conflictsofinterest{{Andrés Bastidas-Fuertes is the CEO of Smartwork
    ...
    data analysis, or publication of this work. All authors are aware
    of this relationship. The remaining authors declare no conflicts
    of interest.}
} %MDPI: Please check whether there are any potential
