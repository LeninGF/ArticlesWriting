...
% a Post Office Box number can be added instead. <<AUTHOR:Added.>>
 Ecuador; raysafuertesa@gmail.com~(R.A.F.-A.)} %<<AUTHOR: acronym added>>
...
\dataavailability{The anonymized patient dataset from the Isidro Ayora
  ...
  2026.  %MDPI:
                                ...
                                %available for the reader>><<AUTHOR:
                                %on behalf of your request we have
                                %added the date the resource was created>>
 }
...
\conflictsofinterest{{Andrés Bastidas-Fuertes is the CEO of Smartwork
    S.A. This employment relationship is declared for transparency
    purposes. He contributed to this research as an external
    collaborator and former PhD graduate of our institution
    (EPN). Smartwork S.A. had no role in the funding, design, conduct,
  data analysis, or publication of this work. All other authors are
  aware of this relationship. The remaining authors declare no
  conflicts of interest.} } %MDPI: Please check whether there are any potential
                 ...
                 %that need to be declared>><<AUTHOR: as noted by
                 %MDPI, we included a disclosure of our relationship
                 %with A.B.-F. and his company.
