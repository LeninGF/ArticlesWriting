...
\address{%
$^{1}$ \quad Departamento de Informática y Ciencias de la Computación, Escuela Politécnica Nacional,  \mbox{Quito 170525, Ecuador;}  lenin.falconi@epn.edu.ec~(L.G.F.); monserrate.intriago@epn.edu.ec~(M.I.-P.); 
juan.benavides@epn.edu.ec~(J.B.)\\
$^{2}$ \quad Smartwork S.A.,  {Quito 170503, Ecuador;} %MDPI: Newly
                                %added  information. Please
                                %confirm. <<AUTHOR: Confirmed!>>
 andres.bastidas@smartwork.com.ec\\
...
% a Post Office Box number can be added instead. <<AUTHOR:Added.>>
 Ecuador; raysafuertesa@gmail.com}
...
\dataavailability{The anonymized patient dataset from the Isidro Ayora
  ...
  \url{https://github.com/LeninGF/preeclampsiaML}.  %MDPI:
